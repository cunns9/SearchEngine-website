...
$('#btn-area').click(function() {
    ...
    function GenerationST(pokemon) {
        return`
        <div>
        <h2>${GenerationST.name}
        <img src="${pokemon.url}" alt="img of ${bulbasaur}"/>
        </div>
        `;
    }

    document.querySelector(".js-container").innerHTML = GenerationST(results[0])*/